...
<body>
    ...
    <label for="txtgeopolicial">Coordenadas</label><textarea name="geom" id="txtgeopolicial" class="form-control" rows="10" readonly="" title="Coordenadas de la estación policial"></textarea><br />
